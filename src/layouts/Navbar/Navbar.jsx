        ...
        <nav className=" bg-white border-b border-b-slate-200">
            <div className="c-container py-3">
                <div className="flex items-center justify-between">
                    ...
                    {/* navbar nav */}
                    <div className={`fixed top-0 bottom-0 right-0 z-50 bg-white border-l border-l-slate-100 transition-all ${open ? 'w-60 opacity-100 visible' : 'w-64 invisible opacity-0'} md:z-auto md:opacity-100 md:visible md:w-auto md:bg-transparent md:border-l-none md:static`}>
