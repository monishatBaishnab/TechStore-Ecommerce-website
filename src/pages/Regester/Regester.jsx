        ...
        <div className="bg-slate-100 min-h-screen p-5 md:p-10 dark:bg-slate-600">
            <div className='max-w-md mx-auto'>
                <div className="bg-white p-5 md:p-10 relative dark:bg-slate-700">
                    <h4 className="text-2xl text-center mb-5 font-medium dark:text-white">Create User</h4>
                    <p className="text-center text-slate-500 dark:text-slate-300 mb-2">Process of registering and configuring user access in digital platforms.</p>
                    ...
                    <p className="mt-3 text-slate-500 dark:text-slate-300">If you have an account yet, Please <Link to='/Login' className="text-violet-500">Log in.</Link></p>
                    ...
                    <Link to='/' className="absolute top-5 left-5 p-2 bg-slate-100 rounded-md cursor-pointer dark:text-white dark:bg-slate-600">
